  ...
  return (
    ...
    <div className="flex flex-col gap-16">
      <div className="text-sm font-semibold">
        ...
        <p className="text-gray-800">{studentData?.studentName}</p>
      </div>
    </div>
    {/* dob */}
    <div className="flex flex-col gap-16">
    ...
    <div className="flex flex-col gap-16">
      ...
      <div className="text-sm font-semibold">
        ...
        <p className="text-gray-800">{studentData?.firstLanguage ? studentData?.firstLanguage : "N/A"}</p>
      </div>
    </div>
    {/* salary expectations */}
    <div className="flex flex-col gap-16">
      <div className="text-sm font-semibold">
        ...
        <p className="text-gray-800">{studentData?.religion ? studentData?.religion : "N/A"}</p>
      </div>
    </div>
  </div>
  )
